...
function upload() { 
	...
	$("#ajaxform").ajaxSubmit({ 
		...
		success : function(data) { // 데이터 전송에 성공한 후 실행되는 부분
			...
			$("#galleryImg").val(data2); // userImage에 값을 data2로 설정한다.
		},
...
<body>
	...
	<h2>lee 파일업로드</h2>
	<div class="container">
		<form id="ajaxform" action="imageUpload.do" method="post"
			enctype="multipart/form-data">
		<p>
			<input multiple="multiple"  style="width: 200px;" type="file" name="files" onchange="upload()">
	...
	<h2>gallery 파일업로드</h2>
	<form action="imageUpload.do" name="userInfo" id="joinForm" method="post" >
			<fieldset>
				<legend>갤러리 입력 폼</legend>
				<p>
				<p>
					<label for="galleryNo">글번호</label><input type="text" style="width: 200px;" name="galleryNo" id="galleryNo" />
				<p>
				<p>
				...
				<p>
				<p>
					<label for="filenames">이미지 파일명</label><input type="text" style="width: 200px;" name="filenames" id="filenames" />
				<p>
				...
				<div class="form-group">
					<p>
						<label for="filenames" class="filenames"><b>사진</b></label> <img id="pic"
